        ...
        <div style="flex: 1; padding: 30px 34px; min-width: 280px;">
          ...
          <div style="border-top: 1px solid #eee; padding-top: 20px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 10px;">
              ...
              <!-- Día 3 — en preparación -->
              <div style="display: flex; align-items: center; gap: 14px; padding: 13px 16px;
                           background: #f8f9fa; border-radius: 9px; border-left: 3px solid #ddd;
                           opacity: 0.5; cursor: default;">
                <span style="background: #ccc; color: white; border-radius: 50%;
                             width: 30px; height: 30px; display: flex; align-items: center;
                             justify-content: center; font-size: 0.78rem; font-weight: 700;
                ...
                <div style="flex: 1;">
                  ...
                  <div style="color: #888; font-size: 0.78rem; margin-top: 3px;">Próximamente</div>
                </div>
                <span style="background: #e9ecef; color: #999; padding: 2px 10px; border-radius: 10px;
                             font-size: 0.72rem; font-weight: 600; flex-shrink: 0;">En preparación</span>
              </div>
